...
extensions used by the upstream full build, injects them, signs the final app
with the runner's `prepare-ci-signing.sh` assets, and publishes the signed IPA.
